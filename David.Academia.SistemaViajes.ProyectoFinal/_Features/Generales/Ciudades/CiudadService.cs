...
namespace David.Academia.SistemaViajes.ProyectoFinal._Features.Generales.Ciudades
{
    public class CiudadService
    {
        ...
        public CiudadService(UnitOfWorkBuilder unitOfWorkBuilder, IMapper mapper)
        {
        ...
        public async Task<Respuesta<CiudadDto>> CrearCiudad(CiudadDto ciudadDto)
        {
            ...
            if (await _ciudadRepository.AsQueryable().AnyAsync(c => c.Nombre.ToLower() == ciudadDto.Nombre.ToLower()))
            {
                respuesta.Valido = false;
